...
if (isset($_GET['keyword'])) {
    ...
    $sql = "SELECT
                ...
                CONCAT(teacher.name, ' ', teacher.surname) AS teacher_fullname
            FROM department
            LEFT OUTER JOIN teacher
                ON department.teacher_id = teacher.teacher_id
            WHERE 
                department.dep_id LIKE '%$keyword%' OR
                department.dept_name LIKE '%$keyword%' OR
                CONCAT(teacher.name, ' ', teacher.surname) LIKE '%$keyword%'";
    $result = $con->query($sql);
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        <div class="d-flex justify-content-between align-items-center">
                            <b>หัวหน้าแผนก</b>
                            <i class="bi bi-arrow-down-up sort" onclick="sortTable(1)"></i>
                        </div>
                    </th>
                    <th>
                        <b>จัดการ</b>
