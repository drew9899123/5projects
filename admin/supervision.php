...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-end gap-3 ">
            ...
            <div>
                <a href="edit_supervision.php" class="btn btn-primary p-2">จัดการการเป็นครูนิเทศ</a>
            </div>
        </div>
        <?php
        ...
        echo '<table class="table table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><a href="?page=' . $page . '&sort=teacher_fullname&order=' . ($sortColumn == 'teacher_fullname' && $sortOrder == 'ASC' ? 'DESC' : 'ASC') . '&keyword=' . $keyword . '">ครูนิเทศ</a></th>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo '<tr>
                    ...
                    <td class="d-flex justify-content-center">
                        <a href="edit_dept.php?dept_id=' . $row['dept_id'] . '" type="submit" class="btn btn-warning disabled"><i class="bi bi-pen-fill"></i></a>
                    </td>
